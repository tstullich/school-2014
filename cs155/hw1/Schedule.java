...
public class Schedule
{
    ...
    /**
         Constructs an Schedule with a given assignment of tasks
    ...
    public int getTotalTime1()   { return totalTime1; }
    ...
    public int getTotalTime2()   { return totalTime2; }
    ...
    public boolean[] getSked()   { return Arrays.copyOf(isForFirstProcessor, isForFirstProcessor.length);  }
    ...
    public int getTotalTime()    { return Math.max(totalTime1, totalTime2); }
